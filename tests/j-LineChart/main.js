function initPage($,Tangular) {
  var Thelpers = Tangular.helpers;

Thelpers.pluralize = function(r, e, t, a, n) {
    return r || (r = 0),
    'number' != typeof r && (r = parseFloat(r.toString().replace(/\s/g, '').replace(',', '.'))),
    r.pluralize(e, t, a, n)
}
,
Thelpers.format = function(r, e, t, a) {
    var n = typeof r;
    if (r == 0 || r == null)
        return '';
    if ('number' === n || r instanceof Date)
        return r.format(e == null ? null : e, t, a);
    'string' !== n && (r = r.toString()),
    r = r.trim();
...
;
Thelpers.def = function(e, n) {
    return e ? Thelpers.encode(e) : n || '---'
}
;
Thelpers.currency = function(e, t) {
    switch (typeof e) {
    case 'number':
        return e.currency(t);
    case 'string':
        return e.parseFloat().currency(t);
    default:
        return ''
    }
}
  ...
  COMPONENT('linechart', 'type:normal;pl:10;pr:10;pt:10;pb:25;prselected:0;limit:0;fill:false;point:5;fillopacity:0.1;offsetX:0;offsetY:10;selected:{{ value | format(0) }};templateY:{{ value | format(0) }};templateX:{{ value }};axisY:true;axisX:true;height:0;width:0', function(self, config) {
    ...
    self.make = function() {
      ...
      self.empty().append('<svg></svg>');// modified by lwf
      //self.empty().append(document.createElementNS("http://www.w3.org/2000/svg", "svg"));
      svg = self.find('svg');
